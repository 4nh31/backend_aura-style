 ...
 *     description: Retorna una lista de todas las reseñas disponibles.
 *     responses:
 *       200:
 ...
 *     description: Agrega una nueva reseña para un producto.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Elimina una reseña según el ID proporcionado.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
